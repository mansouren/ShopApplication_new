...
namespace ShopApplication.Services
{
    ...
    {
        public static readonly string PgwSite = "https://pgwtest.bpm.bankmellat.ir/pgwchannel/startpay.mellat";
        ...
        public async Task<bpPayRequestResponse> bpPayRequest(long orderId, long priceAmount, string additionalText)
        {
            try
            {
                var pgc = new PaymentGatewayClient();
                var result = await pgc.bpPayRequestAsync(terminalId, userName, password, orderId, priceAmount, localDate, localTime,
        ...
        public async Task<bpVerifyRequestResponse> VerifyRequest(long orderId, long saleOrderId, long saleReferenceId)
        {
            try
            {
                var pgc = new PaymentGatewayClient();
                var result = await pgc.bpVerifyRequestAsync(terminalId, userName, password, orderId, saleOrderId, saleReferenceId);
                return result;
            }
            catch (Exception Error)
            {
        ...
        public async Task<bpSettleRequestResponse> SettleRequest(long orderId, long saleOrderId, long saleReferenceId)
        {
            try
            {
                var pgc = new PaymentGatewayClient();
                var result =await pgc.bpSettleRequestAsync(terminalId, userName, password, orderId, saleOrderId, saleReferenceId);
                return result;
            }
            catch (Exception Error)
            {
        ...
        public async Task<bpInquiryRequestResponse> InquiryRequest(long orderId, long saleOrderId, long saleReferenceId)
        {
            try
            {
                var pgc = new PaymentGatewayClient();
                var result =await pgc.bpInquiryRequestAsync(terminalId, userName, password, orderId, saleOrderId, saleReferenceId);
                return result;
            }
            catch (Exception Error)
            {
        ...
        public async Task<bpReversalRequestResponse> bpReversalRequest(long orderId, long saleOrderId, long saleReferenceId)
        {
            try
            {
                var pgc = new PaymentGatewayClient();
                var result= await pgc.bpReversalRequestAsync(terminalId, userName, password, orderId, saleOrderId, saleReferenceId);
                return result;
            }
            catch (Exception error)
            {
