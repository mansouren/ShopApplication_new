...
namespace ShopApplication.DataLayer.Migrations
{
    ...
    [Migration("20220124143318_Init_factor_factorDetail")]
    partial class Init_factor_factorDetail
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShopApplication.DataLayer.Entities.Factor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ShopApplication.DataLayer.Entities.FactorDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ShopApplication.DataLayer.Entities.Feild", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ShopApplication.DataLayer.Entities.ProductFeild", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ShopApplication.DataLayer.Entities.FactorDetail", b =>
                {
                    b.HasOne("ShopApplication.DataLayer.Entities.Factor", "Factor")
            ...
            modelBuilder.Entity("ShopApplication.DataLayer.Entities.ProductFeild", b =>
                {
                    b.HasOne("ShopApplication.DataLayer.Entities.Feild", "Feild")
                        .WithMany("ProductFeilds")
